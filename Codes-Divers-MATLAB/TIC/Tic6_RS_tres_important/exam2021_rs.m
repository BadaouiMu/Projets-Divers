function RS(pp,m,t,p,X,B) 
% %---------------A modifier----------------%
% %primpoly(m,'all') 
% pp=input('pp') ; %utilise %primpoly(4,'all') pour avoir le nb 
% m=input('m');
% t=input('t'); %capacite de correction
% p=input('p') ;    %proba d err de canal donné
% X=[ 1 12 11 4 15 2 12 2 10] ; %seq a code %
